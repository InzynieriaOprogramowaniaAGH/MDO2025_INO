...
## Pobrałem plik /root/anaconda-ks.cfg
...
%end
```
## Uruchamiam instalator, podaję plik odpowiedzi jako jeden z argumentów
![alt text](image-36.png)

## Po uruchomieniu kontener działa i zwraca plik index.html
