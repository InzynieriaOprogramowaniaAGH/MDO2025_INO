...
i uruchommiono kontener w trybie interkatywnym poleceniem `sudo docker start -ai dinput`.

![](https://github.com/InzynieriaOprogramowaniaAGH/MDO2025_INO/blob/AN417592/ITE/GC_L05/images/docker%20start%20-ai%20dinput.png?raw=true)

*Rys. 4 uruchomienie kontenera w trybie interaktywnym*
