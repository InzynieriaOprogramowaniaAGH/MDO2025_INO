...
![Zdjecie4](fragment klucza SSH.png)
...
![Zdjecie5](test polaczenia z GitHub.png)
...
![Zdjecie8](docker images.png)

2.	Zalogowanie się do dockera.

![Zdjecie9](docker login.png)
...
![Zdjecie20](pliki docker.png)

5.	Budowanie obrazu

![Zdjecie21](docker budowa.png)

6.	Budowanie obrazu testowego

![Zdjecie22](docker testy.png)
...
![Zdjecie24](uruchomienie poprzedniego.png)

3.	Sklonowanie repozytorium na wolumin wejściowy.

![Zdjecie25](kolonowanie repo na wejsciowy.png)

4.	Uruchomienie kontenera i przeprowadzenie buildu wewnątrz kontenera

![Zdjecie26](build wewnatrz kontenera.png)

5.	Sprawdzenie zawartości wolumina wyjściowego

![Zdjecie27](Sprawdzanie drugiego wolumina.png)

6.	Przeprowadzenie tej samej operacji, ale klonowanie  przeprowadzono wewnątrz kontenera za pomocą gita.

![Zdjecie28](klonowanie wewnatrz kontenera.png)

EKSPORTOWANIE PORTU
1.	Stworzenie własnej sieci mostkowej

![Zdjecie29](stworzenie wlasnej sieci mostkowej.png)

2.	Uruchomienie kontenera jako serwer iperf3

![Zdjecie30](uruchomienie jako iperf3.png)

3.	Test stworzonego serwera

![Zdjecie31](test serwera.png)

4.	Uruchomienie klienta w drugim kontenerze

![Zdjecie32](na drugim kontenerze.png)

5.	Uruchomienie serwera z wystawionym portem na hosta

![Zdjecie33](port na hosta.png)

6.	Uruchomienie serwera z wystawionym portem z innego hosta

![Zdjecie34](port na innego hosta.png)

7.	Zapisanie wyników testu 

![Zdjecie35](zapisanie wynikow log.png)

INSTALACJA JENKINS

![Zdjecie36](network create.png)

![Zdjecie37](cos tam dalej.png)

![Zdjecie38](kolejne cos tam dalej.png)

![Zdjecie39](jenkins koncowy.png)