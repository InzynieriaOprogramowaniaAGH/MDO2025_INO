...
wget http://192.168.176.1:3333/cpm_build.tar -O /tmp/cpm_build.tar

docker load -i /tmp/cpm_build.tar
...
[Service]
Restart=always
ExecStart=/usr/bin/docker run --rm -p 3000:3000 --name cpm_build cpm_build
ExecStop=/usr/bin/docker stop cpm_build
