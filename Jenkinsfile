        ...
        stage('Build') {
            steps {
                sh '''
                    ...
                    docker run --name my-httpd-build-container2 my-httpd-builder:latest sh -c "
                    ...
                    docker commit my-httpd-build-container2 my-httpd-built:latest
                    docker rm my-httpd-build-container2
